...
The models presented in the tutorials are formed by a system of equations constucted with blocks of elementary processes ([Ghiaus 2022](https://hal.archives-ouvertes.fr/hal-03484064/document)).
